...
void child(void)
{
	...
	printf("Map of child's virtual memory:\n ");
	show_maps();
...
void parent(pid_t child_pid)
{
	...
	printf("Map of parent's virtual memory:\n ");
	show_maps();
	...
	printf("Parent: physical address of the private buffer: %ld\n", get_physical_address((uint64_t)heap_private_buf)); 
...
int main(void)
{
	...
	printf("The physical address is: %ld", get_physical_address((uint64_t)heap_private_buf));
